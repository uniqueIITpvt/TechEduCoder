...
const CourseCard: FC<Props> = ({ item, isProfile }) => {
  return (
    <div className="w-full bg-white dark:bg-slate-500 dark:bg-opacity-20 border dark:border-[#ffffff1d] border-[#00000015] dark:shadow-[bg-slate-700] rounded-md  shadow-sm dark:shadow-inner  hover:-translate-y-1 hover:scale-70  duration-200">
      <Link
      ...
      >
       ...
       <div className="px-3 flex items-center justify-start pt-[0.5rem]">
        ...
        <div className="px-3 pt-[0.4rem]">
          ...
          <div className="w-full flex items-center  justify-start ">
            ...
            <div className="flex items-center ml-[1rem] opacity-70 ">
              ...
              <h5 className=" text-black dark:text-[#fff] font-poppins font-[500] text-[16px] ml-1 mr-1">
                {item.courseData?.length} Lectures
              </h5>
            </div>
          </div>
          <div className="w-full flex items-center justify-start pt-3">
            <div className="flex leading-6">
              <h3 className="text-black dark:text-[#fff] font-poppins font-[700] text-[25px] opacity-95 ">
                {item.originalPrice === 0 ? "Free" : "₹" + item.discountPrice.toFixed(2)}
              </h3>
              <h5 className="pl-2 pt-1 text-[18px]  font-[700] line-through  dark:text-[#fff] text-black opacity-50">
