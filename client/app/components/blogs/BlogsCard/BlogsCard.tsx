    ...
    <Link href={`/blog/${blog?._id}`}>
      <div className="md:flex border-[1px]  w-full flex h-auto p-2 rounded-md shadow-md hover:-translate-y-1 hover:scale-70  duration-200 items-center justify-start">
        ...
        <div className="pl-2  w-full">
            ...
            <Link
              href={`/blog/${blog._id}`}
              className="block  md:text-[26px] text-[22px] font-[700] text-black hover:underline truncate ...  opacity-80 "
            >
              {" "}
            ...
            <div className=" md:mt-0">
              <div className="mt-2 text-gray-500  md:text-[17px]  text-[14] font-poppins  md:font-[500] font-[400] truncate ...">
                {/* {blog.BlogContent.slice(0, 40)} */}
                <span dangerouslySetInnerHTML={{ __html: body.slice(0, 40) }} />
              </div>
              <div>
                {" "}
