  ...
  return (
    <>
      {isLoading ? (
        ...
        <div className="bg-slate-200 pb-16 pt-5">
          <br />

          <div className="relative">
            <h1
              className={`${styles.title} 800px:!text-[45px] text-gradient md:!leading-[50px] !leading-9   `}
            >
              {/* Get in */}
              <span className="text-gradient">
                Uncover <br /> The Future with Our Tech Bookshelf
              </span>
            </h1>

            <h2 className="800px:!text-[20px] text-[18px] text-black dark:text-white font-[700] font-Poppins text-center py-2 mx-5 opacity-80 md:pb-10">
