      ...
      <div className="w-full md:h-auto">
        <div className="relative">
          ...
          >
            ...
            <Image
              src={CLOUDINARY_ASSETS.homeBanner2}
              alt=""
              width={5280}
              height={1980}
            ...
            />
            <Image
              src={CLOUDINARY_ASSETS.homeBanner1}
              alt=""
              width={5280}
              height={1980}
              className="object-cover"
            />
            <Image
              src={CLOUDINARY_ASSETS.homeBanner3}
              alt=""
              width={5280}
              height={1980}
              className="object-cover"
          ...
          <Carousel
            ...
            {/* Ensure your images are responsive */}
            <Image
              src={CLOUDINARY_ASSETS.mobileBanner1}
              alt=""
              width={1600}
              height={1172}
            ...
            />
            <Image
              src={CLOUDINARY_ASSETS.mobileBanner2}
              alt=""
              width={1600}
              height={1172}
              className="object-fill  overflow-hidden"
