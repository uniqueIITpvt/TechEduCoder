      ...
      <div className="w-full h-[50vh] md:h-auto">
        <div className="relative">
          ...
          <div className="absolute bottom-0 left-0 top-0 h-full md:w-[60%] w-[65%]  md:bg-gradient-to-r from-sky-500 md:pt-10 pl-2 md:pl-0">
            <h1 className=" text-[#0a083b] md:text-white text-[24px] md:text-[28px] md:ml-10 pl-4  leading-9  font-bold lg:ml-[5rem] lg:text-[48px]   lg:leading-[56px] lg:font-extrabold font-sans lg:mt-10 opacity-90 mt-8  ">
              Upgrade your learning Skills <br />& Upgrade your life
            </h1>
            {/* Hidden on mobile, visible on md screens and up */}
            <p className=" text-indigo-700 leading-[18px] pt-1  pl-4  text-[14px] font-[700] md:text-[17px] md:ml-9 md:font-[700] md:leading-[22px] lg:ml-20 lg:mt-6">
